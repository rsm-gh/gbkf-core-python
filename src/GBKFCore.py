...
class Header:
    ...
    MAIN_STRING_ENCODING_START = SPECIFICATION_VERSION_START + SPECIFICATION_VERSION_SIZE
    MAIN_STRING_ENCODING_SIZE = 2

    SECONDARY_STRING_ENCODING_START = MAIN_STRING_ENCODING_START + MAIN_STRING_ENCODING_START
    SECONDARY_STRING_ENCODING_SIZE = 2

    KEYS_SIZE_START = SECONDARY_STRING_ENCODING_START + SECONDARY_STRING_ENCODING_SIZE
    KEYS_SIZE_SIZE = 1
